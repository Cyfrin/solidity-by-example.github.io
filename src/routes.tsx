...
import component_defi_uniswap_v4_flash from "./pages/defi/uniswap-v4-flash"
import component_defi_uniswap_v4_limit_order from "./pages/defi/uniswap-v4-limit-order"
import component_defi_uniswap_v4_swap from "./pages/defi/uniswap-v4-swap"
...
import component_foundry_vm_store from "./pages/foundry/vm-store"
...
const routes: Route[] = [
  ...
  {
    path: "/defi/uniswap-v4-flash",
    component: component_defi_uniswap_v4_flash,
  },
  {
    path: "/defi/uniswap-v4-limit-order",
    component: component_defi_uniswap_v4_limit_order,
  },
  {
    path: "/defi/uniswap-v4-swap",
    component: component_defi_uniswap_v4_swap,
  },
  {
    path: "/defi/vault",
  ...
  {
    path: "/foundry/vm-store",
    component: component_foundry_vm_store,
  },
  {
    path: "/function",
