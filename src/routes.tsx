...
import component_app_gassless_token_transfer from "./pages/app/gassless-token-transfer"
...
const routes: Route[] = [
    ...
    {
        path: "/app/gassless-token-transfer",
        component: component_app_gassless_token_transfer
    },
    {
