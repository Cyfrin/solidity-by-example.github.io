...
export const cyfrinLink = "https://www.cyfrin.io/glossary/uniswap-v3-liquidity-solidity-code-examples"
...
const html = `<p>Examples of minting new position, collecting fees, increasing and decreasing liquidity.</p>
