...
export const cyfrinLink = "https://www.cyfrin.io/glossary/hiding-malicious-code-with-external-contract-hack-solidity-code-example"
...
<p>In Solidity, any address can be cast into specific contract,
even if the contract at the address is not the one being cast.</p>
